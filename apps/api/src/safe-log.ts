...
const secretNamePattern = '(?:OPENAI_API_KEY|SUPABASE_SERVICE_ROLE_KEY|SUPABASE_ANON_KEY|TELEGRAM_BOT_TOKEN|TELEGRAM_WEBHOOK_SECRET|INTERNAL_CRON_SECRET|RESEND_API_KEY|SUPABASE_DB_PASSWORD|DATABASE_URL)';
